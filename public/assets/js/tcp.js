...
var socket = __webpack_require__(/*! ./socket-client */ "./resources/js/socket-client.js").socket; // Event Emitter


var emit = function emit() {
  var data;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function emit$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(ajaxRequest($('#send-message').attr('action'), $('#send-message').attr('method'), data, false));
...
$(function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            _context3.next = 3;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(confirm('You want to set a meeting?'));
  ...
  $body.on('click', '#send-message', function (e) {
    ...
    var value = msgField.val();

    if (value !== '') {
      emit();
      msgField.css('border', '');
      if ($('#error').length > 0) $('#error').css('display', 'none');
      $('.messages > ul').append("<li class=\"replies\"><img style=\"width: 25px;height: 25px;\" src=\"".concat(src, "\"><p>").concat($('input[type=text]').val(), "</p></li>"));
      msgField.val('');
  ...
  $('#load_chat').on('click', function _callee3(e) {
    var inbox_id;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 4;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(ajaxRequest("load-chat/".concat(inbox_id), 'post'));
