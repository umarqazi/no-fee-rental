      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return ajaxRequest($('#send-message').attr('action'), $('#send-message').attr('method'), data, false);
...
socket.on("listen-chat-event.".concat(currentUser),
/*#__PURE__*/
function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 3:
              ...
              _context3.next = 7;
              return ajaxRequest("accept-meeting/".concat(meeting_id), 'post', null, false);
...
module.exports = __webpack_require__(/*! /home/deployer/no-fee-rental/resources/js/message.js */"./resources/js/message.js");
