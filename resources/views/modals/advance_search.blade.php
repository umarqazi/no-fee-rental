                ...
                <div class="row">
                    ...
                    <div class="col-md-6 price-range-advance-srch">
                        ...
                        <div class="form-group">
                            ...
                            <div class="slider-wrapper">
                                <div class="search-input-wrap">
                                    {!! Form::text('square_min', null, ['id' => 'min_price_2', 'pattern' => '[0-9]', 'class' => 'input-style', 'placeholder' => 'Min Square ft']) !!} -
                                    {!! Form::text('square_max', null, ['id' => 'max_price_2', 'pattern' => '[0-9]', 'class' => 'input-style', 'placeholder' => 'Max Square ft']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
