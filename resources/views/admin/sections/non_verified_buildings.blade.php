    ...
    @foreach($buildings->non_verified as $al)
        <div class="listing-row">
            <div class="img-holder">
                <img src="{{ asset(isset($al->listings[0]->thumbnail) ? $al->listings[0]->thumbnail : '' ?? DLI) }}" alt="" style="height: 205px; width: 100%;" class="main-img" />
            </div>
            <div class="info">
                <p class="title">{{ str_limit(is_exclusive(isset($al->listings[0]) ? $al->listings[0] : null), STR_LIMIT_LIST_VIEW, ' ...') }}</p>
