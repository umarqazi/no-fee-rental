								...
								<div class="listing-row">
									...
									<div class="info">
										...
										<div class="actions-btns">
                                            <a href="{{ route('admin.editListing', $il->id) }}"><span><img src="{{asset('assets/images/edit-icon.png')}}" alt=""></span></a>
                                            <a href="{{ route('admin.copyListing', $il->id) }}"><span><img src="{{asset('assets/images/copy-icon.png')}}" alt=""></span></a>
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4 col-sm-6">
										<div class="listing-thumb">
											...
											<div class="info">
												<p class="title">{{ str_limit($il->display_address, $limit = 25, $end = '...') }}</p>
												<p><i class="fa fa-tag"></i> ${{ $il->rent }}</p>
												<p>Freshness Score : 90%</p>
												<ul>
													<li><i class="fa fa-bed"></i> {{ $il->bedrooms }} Bed</li>
												...
												<div class="list-actions-icons">
                                                    ...
                                                    <a href="{{ route('admin.copyListing', $il->id) }}"><button><i class="fa fa-copy"></i></button></a>
												</div>
											</div>
										</div>
									</div>
