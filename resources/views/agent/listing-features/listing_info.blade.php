        ...
        <span class="invalid-feedback" role="alert">
            {!! $errors->first('square_feet') !!}
				...
				<div class="col-md-6">
                    ...
                    @endif
					<img class="img-thumbnail" src="{{($action && isset($listing->thumbnail)) ? asset('storage/'.$listing->thumbnail) : ''}}" id="img" style="{{($action) ? 'width: 180px;height: 145px;margin-bottom: 15px;' : ''}}">
				</div>
                <div class="col-md-6"></div>
				<div class="col-md-12">
					<div class="form-group">
