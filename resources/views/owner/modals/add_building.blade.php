            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12" style="margin-top: 10px">
                        <div class="form-group">
                            <div>
                                <img class="img-thumbnail" src="{{isset($building->thumbnail) ? Storage::url($building->thumbnail ?? DLI ) : Storage::url(DLI) }}" id="preview-img" style="width: 180px;height: 145px;margin-bottom: 15px;">
                            </div>
...
{!! HTML::script('assets/js/building.js') !!}
