...
<div class="main-wrapper">
    ...
    <div class="Notification-wrapper">
        ...
        <p> <b>Hi {{$data->name}}! </b> Converted 2 Bedroom and 1 Bath with double exposure in a condo located in Midtown East. Windowed Kitchen and Bath. Comfortable living and dining area. The building is located within 5 minutes walking distance to the United Nations. Modest post-war building </p>
        <div class="action-button">
            <a href="{{$data->link}}"><button type="submit">Leave a Review</button></a>
        </div>
