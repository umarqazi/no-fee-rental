    ...
    @foreach ($conversations->archived as $archive)
        <div class="message-row row">
            ...
            <div class="col-sm-6 col-lg-2 col-12 view-buttons">
                <a href="{{ route('renter.loadConversation', $archive->id) }}" class="view-chat-view"> View</a>
                <a href="{{ route('renter.unArchiveConversation', $archive->id) }}" class="view-chat-archive"> UnArchive</a>
            </div>
            <div class="property">
