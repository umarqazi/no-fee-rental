            ...
            <div class="search-property">
                ...
                <div class="price-range-dropdown">
                    ...
                    <div class="price-range-ul">
                        <ul>
                            <li>
                                {!! Form::text('min_price', null, ['class' => 'form-control PPm', 'placeholder' => '$ Min Price', 'id' => 'index-min']) !!}
                            </li>
                            <li>To</li>
                            <li>
                                {!! Form::text('max_price', null, ['class' => 'form-control PPM', 'placeholder' => '$ Max Price', 'id' => 'index-max']) !!}
                            </li>
                        </ul>
                    </div>
                </div>
