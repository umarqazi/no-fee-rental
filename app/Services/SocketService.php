...
class SocketService
{
     ...
     * @var string
     */
    private $protocole = SocketService::NO_SECURE_PROTOCOLE;
    /**
     * @var string
     */
    private $event;
    ...
    {
        if (!in_array($protocole, [SocketService::NO_SECURE_PROTOCOLE, SocketService::SSL_PROTOCOLE, SocketService::TLS_PROTOCOLE])) {
            $protocole = SocketService::NO_SECURE_PROTOCOLE;
        }
